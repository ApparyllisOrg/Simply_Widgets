...
/// {@end-tool}
class ReorderableListViewWithoutMergedSemantics extends StatefulWidget {
  ...
  ReorderableListViewWithoutMergedSemantics({
    Key? key,
  ...
  const ReorderableListViewWithoutMergedSemantics.builder({
    Key? key,
  ...
  @override
  _ReorderableListViewWithoutMergedSemantics createState() => _ReorderableListViewWithoutMergedSemantics();
}

class _ReorderableListViewWithoutMergedSemantics extends State<ReorderableListViewWithoutMergedSemantics> {
